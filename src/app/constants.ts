...
export class API_ENDPOINTS {
  ...
  static ADMIN_UPLOAD_ALUMNOS =
    API_Routers.ADMIN + '/' + ACTIONS.UPDATE + '/' + API_Routers.ALUMNO
  ...
  static CONFIG_HORARIO_CREATE =
    API_Routers.CONFIG + '/' + CONSTANTS.HORARIO + '/' + ACTIONS.CREATE
  static CONFIG_HORARIO_DELETE =
    API_Routers.CONFIG + '/' + CONSTANTS.HORARIO + '/' + ACTIONS.DELETE
  static CONFIG_HORARIO_LIST =
    API_Routers.CONFIG + '/' + CONSTANTS.HORARIO + '/' + ACTIONS.LIST
  static CONFIG_LENGUAJE_CREATE =
    API_Routers.CONFIG + '/' + CONSTANTS.LENGUAJE + '/' + ACTIONS.CREATE
  static CONFIG_LENGUAJE_DELETE =
    API_Routers.CONFIG + '/' + CONSTANTS.LENGUAJE + '/' + ACTIONS.DELETE
  static CONFIG_LENGUAJE_LIST =
    API_Routers.CONFIG + '/' + CONSTANTS.LENGUAJE + '/' + ACTIONS.LIST
  static CONFIG_NIVEL_CREATE =
    API_Routers.CONFIG + '/' + CONSTANTS.NIVEL + '/' + ACTIONS.CREATE
  static CONFIG_NIVEL_DELETE =
    API_Routers.CONFIG + '/' + CONSTANTS.NIVEL + '/' + ACTIONS.DELETE
  static CONFIG_NIVEL_LIST =
    API_Routers.CONFIG + '/' + CONSTANTS.NIVEL + '/' + ACTIONS.LIST
  static CONFIG_GENERO_CREATE =
    API_Routers.CONFIG + '/' + CONSTANTS.GENERO + '/' + ACTIONS.CREATE
  static CONFIG_GENERO_DELETE =
    API_Routers.CONFIG + '/' + CONSTANTS.GENERO + '/' + ACTIONS.DELETE
  static CONFIG_GENERO_LIST =
    API_Routers.CONFIG + '/' + CONSTANTS.GENERO + '/' + ACTIONS.LIST
  static CONFIG_COLECTIVOUV_CREATE =
    API_Routers.CONFIG + '/' + CONSTANTS.COLECTIVOUV + '/' + ACTIONS.CREATE
  static CONFIG_COLECTIVOUV_DELETE =
    API_Routers.CONFIG + '/' + CONSTANTS.COLECTIVOUV + '/' + ACTIONS.DELETE
  static CONFIG_COLECTIVOUV_LIST =
    API_Routers.CONFIG + '/' + CONSTANTS.COLECTIVOUV + '/' + ACTIONS.LIST
  static CONFIG_ROL_CREATE =
    API_Routers.CONFIG + '/' + CONSTANTS.ROL + '/' + ACTIONS.CREATE
  static CONFIG_ROL_LIST =
    API_Routers.CONFIG + '/' + CONSTANTS.ROL + '/' + ACTIONS.LIST
