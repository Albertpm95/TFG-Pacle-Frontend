...
export class API_ENDPOINTS {
    ...
    static CONFIG_NIVEL_CREATE = API_Routers.CONFIG + '/' + CONSTANTS.NIVEL + '/' + ACTIONS.LIST
    ...
    static CONFIG_GENERO_CREATE = API_Routers.CONFIG + '/' + CONSTANTS.GENERO + '/' + ACTIONS.LIST
    ...
    static CONFIG_COLECTIVOUV_CREATE = API_Routers.CONFIG + '/' + CONSTANTS.COLECTIVOUV + '/' + ACTIONS.LIST
