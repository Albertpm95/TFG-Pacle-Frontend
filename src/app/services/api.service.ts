...
export class ApiService {
  ...
  addRolUsuario(rol_nuevo: Rol): Observable<Rol> {
    return this.http.post<Rol>(
      this.apiUrl + API_ENDPOINTS.CONFIG_ROL_CREATE,
      rol_nuevo,
    )
  }
  /** ---------------------------------------------------------------------- */
  ...
  addUsuario(usuario_nuevo: Usuario): Observable<Usuario> {
    return this.http.post<Usuario>(
      this.apiUrl + API_ENDPOINTS.USUARIO_CREATE,
      usuario_nuevo,
    )
  }
  updateUsuario(usuario_editado: Usuario): Observable<Usuario> {
    return this.http.put<Usuario>(
      this.apiUrl + API_ENDPOINTS.USUARIO_UPDATE,
      usuario_editado,
    )
  }
  /** ---------------------------------------------------------------------- */
